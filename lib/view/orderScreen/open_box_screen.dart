...
import 'package:users_app/view/mainScreen/home_screen.dart';
...
class OpenBoxScreen extends StatefulWidget {
  ...
  const OpenBoxScreen({Key? key, required this.selectedOrderId}) : super(key: key);

  @override
  _OpenBoxScreenState createState() => _OpenBoxScreenState();
}
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                        ...
                        orderViewModel.deliverOrderToRider(widget.selectedOrderId);
                        Navigator.push(context, MaterialPageRoute(builder: (context) => HomeScreen(),),);


                    },
                    child: Text("Siparişi Kuryeden Teslim Al"),
                    style: ElevatedButton.styleFrom(
                      foregroundColor: Colors.white,
                      backgroundColor: Colors.blueAccent,
                    ),
